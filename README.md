...
Running the main.py script initializes the required variables and creates a list of game entrants from local resource files. Each entrant is randomly assigned a weapon and armor. Matches are formed by pairing two randomly selected entrants. 
...
- `resource_armor.json` — Add a new or edit existing armor information
